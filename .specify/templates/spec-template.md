...
## Constitution Check *(mandatory for this repository)*

<!--
  For this Claude Code plugin repo, every feature specification MUST briefly explain
  how it complies with the project constitution:
...
- Maintainability & docs: [Naming, changelog impact, compatibility notes, and documentation updates required]
