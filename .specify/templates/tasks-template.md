...
**Optional verification**: The examples below include optional verification tasks; include them only if explicitly requested in the feature specification.
...
- [ ] TXXX Security hardening (including review of environment configuration and error handling)
- [ ] TXXX Update changelog and plugin compatibility notes (Claude Code + MCP integrations)
- [ ] TXXX Review `.claude-plugin/plugin.json` and `.mcp.json` for consistency with implementation changes
